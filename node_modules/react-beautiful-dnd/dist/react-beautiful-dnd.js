(function (global, factory) {
	...
	*/
	...
	var styleKey = prefix$2('style');
	var canLiftKey = prefix$2('can-lift');
	var isMovementAllowedKey = prefix$2('is-movement-allowed');
	...
	*/
	...
	var idleWithoutAnimation = _extends({}, idle$1, {
	...
	var makeMapStateToProps = function makeMapStateToProps() {
	  var getDraggingOverMapProps = index(function (draggingOverWith, draggingFromThisWith, placeholder, shouldAnimatePlaceholder) {
	    return {
	      isDraggingOver: true,
	      draggingFromThisWith: draggingFromThisWith,
	      draggingOverWith: draggingOverWith,
	  ...
	  var getHomeNotDraggedOverMapProps = index(function (draggingFromThisWith, placeholder) {
	    return {
	      isDraggingOver: false,
	      draggingFromThisWith: draggingFromThisWith,
	      draggingOverWith: null,
